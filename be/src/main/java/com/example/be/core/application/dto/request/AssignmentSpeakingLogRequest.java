...
public class AssignmentSpeakingLogRequest {

  @NotNull(message = "과제 ID가 빈 값이어서는 안됩니다.")
  ...
  public AssignmentSpeakingLogRequest(Long assignmentId, String title, String voiceRecord,
      String voiceText) {
