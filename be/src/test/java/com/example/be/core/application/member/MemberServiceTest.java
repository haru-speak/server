  ...
  class SaveMemberTest {
    ...
    class DupulicateMemberTest {
      ...
      public void DuplicateSaveMemberTest() {
        // given
        MemberFormRequest memberFormRequest1 = new MemberFormRequest("승연", "jakalroni@naver.com", "1111", "aaaaa");
        MemberFormRequest memberFormRequest2 = new MemberFormRequest("재욱", "jakalroni@naver.com", "1234", "aaaaa");
